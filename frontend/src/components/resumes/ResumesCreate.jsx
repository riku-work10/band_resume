...
const ResumesCreate = ({ onClose }) => {
  ...
  // Portalのレンダー部分
  const modalContent = (
// 重要な部分のスタイルをレスポンシブに調整

<div
  className="fixed inset-0 bg-black bg-opacity-50 z-[9999] flex items-center justify-center px-4" // 横padding追加でスマホでも端にくっつかない
  onClick={onClose}
>
  <div
    className="bg-stone-800 dark:bg-stone-800 text-white max-h-[calc(100vh-30px)] overflow-y-auto w-full max-w-xl rounded-2xl shadow-xl p-6"
