  ...
  module V1
    class S3Controller < ApplicationController
      ...
      def presigned_url
        ...
        obj = s3.bucket(ENV.fetch('S3_BUCKET_NAME', nil)).object("profile_images/#{user_id}/#{file_name}")
      ...
      def delete_object
        ...
        s3 = Aws::S3::Resource.new(region: ENV.fetch('AWS_REGION', nil))
        bucket = s3.bucket(ENV.fetch('S3_BUCKET_NAME', nil))
        # 対象オブジェクトを読み込む
